...
Sitecore Commerce Engine Customize Ordernumber plugin (Sitecore Experience Commerce 9.1)
======================================
...
3. To your SitecoreServicesConfigurationExtensions.cs class, add the line below towards the end:
